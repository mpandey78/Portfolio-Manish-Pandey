...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | Manish Pandey";
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: [ "MEAN-Stack developer", "Angular Frontend developer","NodeJs Backend developer"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
...
s1.async=true;
s1.src='https://embed.tawk.to/63cc0562c2f1ac1e202ee5b2/1gnafb2uo';
s1.charset='UTF-8';
...
// var s1=document.createElement("script"),s0=document.getElementsByTagName("script")[0];
// s1.async=true;
// s1.src='https://embed.tawk.to/63cc0562c2f1ac1e202ee5b2/null';
// s1.charset='UTF-8';
// s1.setAttribute('crossorigin','*');
// s0.parentNode.insertBefore(s1,s0);
// })();
